...
public class AESV2 {
    ...
    /**
     * This method would encrypt the given content  *   * @param strToEncrypt The content to encrypt  * @return The encrypted format of the content  * @throws InvalidKeySpecException  * @throws NoSuchAlgorithmException  * @throws NoSuchPaddingException  * @throws InvalidAlgorithmParameterException  * @throws InvalidKeyException  * @throws UnsupportedEncodingException  * @throws BadPaddingException  * @throws IllegalBlockSizeException
     */
    ...
    /**
     * This method would decrypt the given content  *   * @param strToDecrypt The content to decrypt  * @return The decrypted format of the content  * @throws InvalidKeySpecException  * @throws NoSuchAlgorithmException  * @throws NoSuchPaddingException  * @throws InvalidAlgorithmParameterException  * @throws InvalidKeyException  * @throws BadPaddingException  * @throws IllegalBlockSizeException
     */
